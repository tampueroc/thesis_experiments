...
LOGGER = logging.getLogger("wildfire.train.transformer_static_film_head_01")
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        parents=[pre_parser],
        description=("Train static-FiLM-head transformer latent predictor on sequence embeddings with fire_id-level train/val/test split."),
    )
    parser.add_argument(
        "--embeddings-root",
        type=Path,
    ...
    parser.add_argument("--variant", default=cfg_value("variant", "model_01_static_film_head"))
    parser.add_argument(
        "--dataset-windowing",
