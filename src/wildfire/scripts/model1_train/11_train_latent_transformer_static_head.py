...
LOGGER = logging.getLogger("wildfire.train.transformer_static_head_01")
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        parents=[pre_parser],
        description=(
            "Train static-head transformer latent predictor on sequence embeddings "
    ...
    parser.add_argument("--variant", default=cfg_value("variant", "model_01_static_head"))
    parser.add_argument(
        "--dataset-windowing",
...
def main() -> None:
    ...
    config = StaticHeadTransformerConfig(
    ...
    model = StaticHeadTransformerLatentPredictor(config).to(device)
