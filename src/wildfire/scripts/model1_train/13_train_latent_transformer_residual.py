...
LOGGER = logging.getLogger("wildfire.train.transformer_residual_01")
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        parents=[pre_parser],
        description=(
            "Train residual transformer latent predictor on sequence embeddings "
    ...
    parser.add_argument(
        ...
        help="Architecture family for this trainer.",
    )
    parser.add_argument(
        "--variant",
        default=cfg_value("variant", "model_01_residual"),
    ...
    parser.add_argument("--hidden-dim", type=int, default=int(cfg_value("hidden_dim", 256)), help="Unused legacy LSTM hidden size.")
    parser.add_argument("--num-layers", type=int, default=int(cfg_value("num_layers", 4)), help="Transformer layer count.")
    parser.add_argument(
        "--dropout", type=float, default=float(cfg_value("dropout", 0.1)), help="Transformer dropout."
    )
    parser.add_argument(
        "--bidirectional",
        action="store_true",
        default=bool(cfg_value("bidirectional", False)),
        help="Unused legacy flag kept for config compatibility.",
    )
    parser.add_argument(
        "--d-model",
        type=int,
