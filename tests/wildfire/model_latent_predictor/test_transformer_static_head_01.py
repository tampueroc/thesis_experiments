...
def test_static_head_transformer_latent_predictor_forward_shape() -> None:
    ...
    model = StaticHeadTransformerLatentPredictor(config)
...
def test_static_head_transformer_rejects_wrong_categorical_width() -> None:
    config = StaticHeadTransformerConfig(
        input_dim=8,
        output_dim=8,
        static_num_dim=2,
